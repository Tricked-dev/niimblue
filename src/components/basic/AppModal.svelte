...
<dialog
  ...
  class="fixed inset-0 m-auto w-full max-w-2xl max-sm:max-w-[90vw] max-sm:h-[80vh] max-sm:my-auto rounded-lg bg-zinc-900 border border-zinc-700 shadow-2xl p-0 backdrop:bg-black/60 open:flex open:flex-col">
